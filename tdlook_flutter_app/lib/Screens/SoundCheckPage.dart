...
class SoundCheckPage extends StatefulWidget {
  ...
  SoundCheckPage({Key key, this.photoType, this.gender, this.measurement}): super(key:key);
...
class _SoundCheckPageState extends State<SoundCheckPage> {
  ...
  void _moveToNextPage() {
    ...
    CameraCapturePage(photoType: widget.photoType, measurement: widget.measurement, gender: widget.gender)
    ));
  }
