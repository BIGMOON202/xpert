...
enum _TutorialStep {
  twoPhotos, avatar, recommendations
}
...
extension _TutorialStepExtension  on _TutorialStep {
  ...
  String get title {
    switch (this) {
      case _TutorialStep.twoPhotos: return 'Take only';
      case _TutorialStep.avatar:  return 'Generate an';
      case _TutorialStep.recommendations:  return 'Get your';
    }}

  String get highlitedTitle {
    switch (this) {
      case _TutorialStep.twoPhotos: return 'two photos';
      case _TutorialStep.avatar:  return '3D avatar';
      case _TutorialStep.recommendations:  return 'size recommendation';
    }}
  ...
  String get subtitle {
    switch (this) {
      ...
      case _TutorialStep.recommendations:  return 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.';
    }}
  ...
  Widget build(BuildContext context) {
      ...
      Widget dotFor({_TutorialStep step}) {
        ...
        return AnimatedContainer(
          ...
          decoration: BoxDecoration(
              ...
              color: selected ? SessionParameters().selectionColor : SessionParameters().mainFontColor.withOpacity(0.1)),
          ...
          child:Column(
            ...
            children: [
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Text(step.title, style: TextStyle(color: SessionParameters().mainFontColor, fontSize: 16, fontWeight: FontWeight.bold)),
                    SizedBox(width: 8),
                    Container(decoration: BoxDecoration(
                        borderRadius: BorderRadius.all(Radius.circular(3)), color: SessionParameters().mainFontColor),
                        child: Padding(padding: EdgeInsets.all(4), child: Text(step.highlitedTitle, style: TextStyle(color: SessionParameters().selectionColor, fontWeight: FontWeight.bold, fontSize: 16))))]),
              Padding(
                  padding: EdgeInsets.only(top:8, left: 37, right: 37, bottom: 20),
                  child: Text(step.subtitle, style: TextStyle(color: SessionParameters().mainFontColor.withOpacity(0.5), fontSize: 14, fontWeight: FontWeight.normal)))],
          ));
    }
    ...
    var container = Stack(
      ...
      value: _markedAsDoNotShow,
                ...
                Text('Do not show me this again', style: TextStyle(color: SessionParameters().mainFontColor, fontSize: 14, fontWeight: FontWeight.normal),)],
              )),
              SizedBox(height: 16),
              Padding(
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          centerTitle: true,
          title: Text('How it works', textAlign: TextAlign.center, maxLines: 2,),
