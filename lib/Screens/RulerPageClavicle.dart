...
class _RulerPageStateClavicle extends State<RulerPageClavicle> {
  ...
  void _updateValuesFor(int minIndex, int maxIndex) {
    ...
    setState(() {
      if (widget.selectedMeasurementSystem == MeasurementSystem.metric) {
        ...
        double oneSegmentValue = (maxValue - minValue) / (numberOfRulerElements ?? 1);
  ...
  Widget build(BuildContext context) {
    ...
    var itemCount = (numberOfRulerElements ?? 0) + 1;
    ...
    ScrollablePositionedList _listView = ScrollablePositionedList.builder(
      ...
      padding: EdgeInsets.only(
          top: (_listHeight * 0.5 - _lineOffset), bottom: (_listHeight * 0.5 - _lineOffset)),
      itemCount: itemCount,
                        ...
                        child: Padding(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                  fontWeight: FontWeight.w500,
                                  fontSize:
                                      widget.selectedMeasurementSystem == MeasurementSystem.metric
                                          ? 20
                                          : 30,
                                  color: Colors.white),
                            ))))
