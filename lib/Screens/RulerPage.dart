...
class _RulerPageState extends State<RulerPage> {
  ...
  late RulerViewController _controller;
              ...
              children: [
                FittedBox(
                    ...
                    child: Text(
                      ...
                      style:
                          TextStyle(fontWeight: FontWeight.w900, fontSize: 60, color: Colors.white),
                    )),
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: SegmentedControl(onChanged: (i) {
            final system = i == 0 ? MeasurementSystem.imperial : MeasurementSystem.metric;
