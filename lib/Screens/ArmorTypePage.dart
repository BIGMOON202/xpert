...
enum ArmorType { outer, concealed }

extension ArmorTypeExtension on ArmorType {
  String get imageName {
    switch (this) {
      case ArmorType.outer:
        return 'armor_outer.png';
      case ArmorType.concealed:
        return 'armor_concealed.png';
    }
  }
...
class _ArmorTypePageState extends State<ArmorTypePage> {
  ...
  Widget build(BuildContext context) {
                  ...
                  child: Row(
                    children: [
                      ...
                      Radio(
                        ...
                        onChanged: (newVal) {
                          setState(() {
                            this.selectedType = ArmorType.values[newVal as int];
                          });
                        },
                      ),
                    ],
    ...
    var appealPhrase = SessionParameters().selectedUser == UserType.endWearer
        ? 'Do you wear your'
        : 'Does end-wearer wear the';
