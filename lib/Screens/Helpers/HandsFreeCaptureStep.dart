enum TFOptionalSound {
  ...
  capture,
  placePhone,
  placePhoneRetakeFront,
  placePhoneRetakeOnlySide,
  waitForResults
}
...
enum TFStep {
  ...
  retakeFrontIntro,
  retakeFrontGreat,
  retakeFrontTakeSteps,
  retakeFrontCheckFeet,
  retakeFrontHoldPosition,
  retakeFrontDone,
  retakeSideIntro,
  retakeSideTurnBody,
  retakeSideStayStill,
  ...
  retakeOnlyFrontIntro,
  retakeOnlyFrontGreat,
  retakeOnlyFrontTakeSteps,
  retakeOnlyFrontCheckBody,
  retakeOnlyFrontCheckFeet,
  retakeOnlyFrontHoldPosition,
  retakeOnlyFrontDone,

  retakeOnlySideIntro,
  retakeOnlySideGreat,
  retakeOnlySideTakeSteps,
  retakeOnlySideCheckBody,
  retakeOnlySideTurnBody,
  retakeOnlySideStayStill,
  retakeOnlySideDone
}
  ...
  String audioTrackName() {
    switch (this) {
      ...
      case TFStep.frontGreat:
        return "tf1.2";
      case TFStep.frontTakeSteps:
        return "tf1.3";
      case TFStep.frontCheckBody:
        return "tf1.4";
      case TFStep.frontCheckFeet:
        return "tf1.5";
      case TFStep.frontHoldPosition:
        return "tf1.6";
      case TFStep.frontDone:
        return "tf1.7";

      case TFStep.sideIntro:
        return "tf2.1";
      case TFStep.sideTurnBody:
        return "tf2.2";
      case TFStep.sideStayStill:
        return "tf2.3";
      case TFStep.sideDone:
        return "tf2.4";
      ...
      case TFStep.retakeFrontGreat:
        return "tf3.2";
      case TFStep.retakeFrontTakeSteps:
        return "tf3.3";
      case TFStep.retakeFrontCheckFeet:
        return "tf3.4";
      case TFStep.retakeFrontHoldPosition:
        return "tf3.5"; // ???? -> 1.6
      case TFStep.retakeFrontDone:
        return "tf3.6"; //????? -> 3.5

      case TFStep.retakeSideIntro:
        return "tf4.1";
      case TFStep.retakeSideTurnBody:
        return "tf4.2";
      case TFStep.retakeSideStayStill:
        return "tf4.3";
      case TFStep.retakeSideDone:
        return "tf4.4";
      ...
      case TFStep.retakeOnlyFrontGreat:
        return "tf5.2";
      case TFStep.retakeOnlyFrontTakeSteps:
        return "tf5.3";
      case TFStep.retakeOnlyFrontCheckBody:
        return "tf5.4";
      case TFStep.retakeOnlyFrontCheckFeet:
        return "tf5.5";
      case TFStep.retakeOnlyFrontHoldPosition:
        return "tf5.6";
      case TFStep.retakeOnlyFrontDone:
        return "tf5.7";
      ...
      case TFStep.retakeOnlySideGreat:
        return "tf6.2";
      case TFStep.retakeOnlySideTakeSteps:
        return "tf6.3";
      case TFStep.retakeOnlySideCheckBody:
        return "tf6.4";
      case TFStep.retakeOnlySideTurnBody:
        return "tf6.5";
      case TFStep.retakeOnlySideStayStill:
        return "tf6.6";
      case TFStep.retakeOnlySideDone:
        return "tf6.7";
