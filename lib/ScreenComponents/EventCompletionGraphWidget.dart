...
class EventCompletionGraphWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var _doublePercent =
        ((event?.completeMeasuremensCount ?? 0) / (event?.totalMeasuremensCount ?? 1));
    ...
    var w = new Row(
      ...
      children: [
        Stack(
          ...
          children: [
            CustomPaint(
              painter: CurvePainter(color: eventStatusColor, angle: angle),
              child: SizedBox(
                width: 45,
                height: 45,
              ),
        ...
        Column(
          ...
          children: [
            Text(
              '${event?.completeMeasuremensCount ?? 0}',
              style: TextStyle(
                color: Colors.white,
                fontSize: 12,
